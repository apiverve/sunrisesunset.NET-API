...
namespace APIVerve
{
    public class SunriseSunsetAPIClient
    {
        ...
        public SunriseSunsetAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public SunriseSunsetAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(sunrisesunsetQueryOptions options)
        {
            try
            {
                if (_isDebug)
